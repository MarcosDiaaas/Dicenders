...
<head>
    ...
    <title>Social / Notificações</title>
</head>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="social.php"><p class="text-clean fs-5 m-2 fw-500">Social</p></a>
              </li>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <div class="container-fluid">
                    ...
                    <a href="mensagens.php"><button class="option-media align-center" ><i class="bi-chat-left-text-fill" style="display: inline-block; margin-right: 4%;"></i><p class="inter-font fw-600" style="display: inline-block;">Mensagens</p></button></a>
                    <a href="notificacoes.php"><button class="option-media align-center" id="notifyBell"><i class="bi-bell-fill" style="display: inline-block; margin-right: 4%;"></i><p class="inter-font fw-600" style="display: inline-block;">Notificações</p></button></a>
                </div>
                <div class=" mt-3">
