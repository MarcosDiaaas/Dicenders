...
<head>
    ...
    <title>Social / Página inicial</title>
</head>
<body class="bg-5 oswald-font" id="body" onload="abreModal()" theme-dicender=>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <div class="container-fluid">
                    <a href="social.php"><button class="option-media align-center" id="homePage"><i class="bi-house-door-fill" style="display: inline-block; margin-right: 4%;"></i><p class="inter-font fw-600" style="display: inline-block;">Página inicial</p></button></a>
